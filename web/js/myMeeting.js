...
function queryList(pageNum) {
    window.location.href="http://localhost:8080/meeting_war_exploded/meeting?action=menuMyMeeting&loginUser="+user+"&pageNum="+pageNum+"&pageSize=10";
}