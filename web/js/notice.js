...
function queryList(pageNums,pageNum) {
    window.location.href="http://localhost:8080/meeting_war_exploded/meeting?action=noticeMyMeeting&pageNums="+pageNums+"&pageSizes=2&pageNum="+pageNum+"&pageSize=2";
}